				...
				<form action="" method="post">
					<div class="form-inner">
						<div class="form-field">
							<div class="field"><input type="name" placeholder="Имя" required="required"></div>
						</div>
						<div class="form-field">
							<div class="field"><input type="tel" placeholder="Телефон" required="required"></div>
						</div>
						<div class="form-field">
							<div class="field"><input type="email" placeholder="Почта" required="required"></div>
						</div>
